...
2. Kiro asks 2–4 targeted clarifying questions upfront about scope, constraints, and edge cases — tailored to your detected tech stack.
...
- **Kiro Team.** "Kiro IDE 0.12 Changelog," kiro.dev, May 6, 2026. [kiro.dev](https://kiro.dev/changelog/ide/0-12/)
- **Kiro Team.** "Introducing Kiro," kiro.dev, July 14, 2025. [kiro.dev](https://kiro.dev/blog/introducing-kiro/)
- **Kiro Team.** "Feature Specs," Kiro Documentation. [kiro.dev](https://kiro.dev/docs/specs/feature-specs/)
- **Kiro Team.** "Quick Plan," Kiro Documentation. [kiro.dev](https://kiro.dev/docs/specs/quick-plan/)
- **Sharma, Ankit.** "Specs just got faster (and smarter)," kiro.dev, May 12, 2026. [kiro.dev](https://kiro.dev/blog/faster-smarter-specs/)
